...
# import models.swin_transformer_v2 as swin_transformer_v2
...
# def get_model(key, pretrained=False, num_classes=2, device='cpu', fp16=False):
#     models_list = {
#         'DC_CDN_Classifier': DC_CDN_Classifier(device=device),
#         'CDCNpp': CDCNpp(),
#         'resnet18': resnet18(num_classes=num_classes, pretrained=pretrained, fp16=fp16),
#         'resnet34': resnet34(num_classes=num_classes, pretrained=pretrained, fp16=fp16),
#         'resnet50': resnet50(num_classes=num_classes, pretrained=pretrained, fp16=fp16)
#     }
